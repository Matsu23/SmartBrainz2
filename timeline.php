        ...
        <div class="col" >
            <div style="position:fixed">
                <div class="m-5  rounded input-group rounded row w-75" style="height:50px;">
                    <img src="Media/Img/SearchIcon.png" class="input-group-text col-2" style="width:100%;height:50px">
                ...
                <div class="m-5 " style="font-size:14px;font-weight:bold;">
                    ...
                    <div  style=" border-radius:100px;margin-right: 15px;font-size:1.5em;"> 
                        <img src="UserData/Default/avatar.png" style="width:50px;" class="pe-5"/><b>Usuario</b><span style="font-size:2em;color:#617881;">LV 25</span>
